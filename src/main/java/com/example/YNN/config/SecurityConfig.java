...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        /* JWT토큰 없이 접근 가능 */
                        .requestMatchers( "/api/signup/**","/api/send/new-password","/api/find/id","/api/login","/api/sms/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://127.0.0.1:5173","http://localhost:5173", "https://43.202.47.254:8080", "http://43.202.47.254:8080", "https://localhost:5173")); // 명시적으로 허용할 출처
